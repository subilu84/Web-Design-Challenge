...
For this homework we'll be creating a visualization dashboard website using visualizations we've created in a past assignment. Specifically, we'll be plotting [weather data](https://github.com/subilu84/python-api-challange/blob/master/data_cities.csv).
